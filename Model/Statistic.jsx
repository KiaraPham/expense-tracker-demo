    ...
    <View style={styles.Bill}>
      ...
      >
        <View style={{ flexDirection: "row", gap: 10 }}>
          <Image
            style={[styles.apple, { borderRadius: 10 }]}
            source={props.BillImage}
          ></Image>
          <View style={{ gap: 2 }}>
        ...
        <View style={{ flexDirection: "row", alignItems: "flex-end" }}>
          ...
          <Text style={[styles.PaymentVal, { color: "#757574", fontSize: 16 }]}>
            00
          </Text>
        </View>
      </View>
  ...
  return (
    <View style={styles.Stat}>
      ...
      <ScrollView
        ...
        style={{ marginTop: 10, borderRadius: 20, marginBottom: -100 }}
      >
        <GraphCard />
        <BillsDue />
      </ScrollView>
