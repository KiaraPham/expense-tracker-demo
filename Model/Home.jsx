      ...
      <View style={{ width: "100%" }}>
        ...
        >
          ...
          <View style={{ flexDirection: "row" }}>
            <Text style={[styles.TransactionAmount, { color: "#F26F2E" }]}>
              $
            </Text>
    ...
    <View style={styles.home}>
      ...
      <View style={styles.QuickSend}>
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
          <Sender senderName="Janmes" senderImage={a1} />
          <Sender senderName="John" senderImage={a2} />
          <Sender senderName="Sara" senderImage={a3} />
          <Sender senderName="Will" senderImage={a4} />
          <Sender senderName="Anna" senderImage={a5} />
        </View>
      </View>
      <ScrollView
        contentContainerStyle={styles.transcontainer}
        scrollEnabled={false}
      >
